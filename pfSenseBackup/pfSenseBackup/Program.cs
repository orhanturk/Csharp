...
namespace pfSenseBackup.pfSenseBackup
{
    /// <summary>
    ...
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            WriteOutput();
            WriteOutput("pfSense Wnidows Backup Tool v{0}.{1} by Orhan Türk", new object[] { Assembly.GetExecutingAssembly().GetName().Version.Major, Assembly.GetExecutingAssembly().GetName().Version.Minor });
            WriteOutput();
        ...
        private static void ParseArguments(IList<string> args)
        {
            ...
            //if (args.Contains("-usessl"))
            //{
            //    PfSenseServerDetails.ServerSsl = args[args.IndexOf("-usessl")];
            //}
            if (args.Contains("-o"))
            {
